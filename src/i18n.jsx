...
i18n.use(initReactI18next).init({
	resources: comfortToI18N({
		...
		// Note.jsx
		"Мы специализируемся на предоставлении уникальных и эффективных решений, разработанных с учетом специфических потребностей арбитражных команд и соло-медиабаеров, работающих с Google Ads.": {
			ua: "Ми спеціалізуємося на наданні унікальних та ефективних рішень, розроблених з урахуванням специфічних потреб арбітражних команд та соло-медіабаєрів, які працюють з Google Ads.",
